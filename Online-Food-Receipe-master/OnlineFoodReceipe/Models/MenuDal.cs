...
namespace OnlineFoodReceipe.Models
{
    public class MenuDal
    {
        ...
        {
            int count = 0;
            string str = "select count(Rid) as TotRId from Menu";
            cmd = new SqlCommand(str, con);
            con.Open();
            dr = cmd.ExecuteReader();
            if (dr.HasRows)
        ...
        {
            string str = "insert into Menu(RName,Photo,Youtube,Ingredient,HTM,VNB,Sname) values(@rname,@image,@youtube,@ingredient,@htm,@vnb,@sname)";
            cmd = new SqlCommand(str, con);
            con.Open();
            ...
            cmd.Parameters.AddWithValue("@sname", m.Sname);
        ...
        public List<Menu> GetAllProducts(string sname,string vnb)
        {
            ...
            string str = "select * from Menu where Sname=@sname and Vnb=@vnb";
            cmd = new SqlCommand(str, con);
            con.Open();
        ...
        {
            List<Menu> list = new List<Menu>();
            string str = "select * from Menu where Sname=@sname and UserId=@id";
            cmd = new SqlCommand(str, con);
            con.Open();
            cmd.Parameters.AddWithValue("@sname", sname);
        ...
        {
            Menu m = new Menu();
            string str = "select * from Menu where Rid=@id";
            cmd = new SqlCommand(str, con);
            con.Open();
            cmd.Parameters.AddWithValue("@id", id);
            dr = cmd.ExecuteReader();
            if (dr.HasRows)
            {
                while (dr.Read())
                {
                    ...
                    m.Sname = dr["Sname"].ToString();
                    m.Photo = dr["Photo"].ToString();
        ...
        public List<State> GetAllState(string vnb)
        {
            ...
            string str = "select distinct Sname from Menu where Vnb=@vnb";
            cmd = new SqlCommand(str, con);
            con.Open();
            cmd.Parameters.AddWithValue("@vnb", vnb);
            dr = cmd.ExecuteReader();
        ...
        {
            List<Menu> list = new List<Menu>();
            string str = "select * from Menu where Vnb=@vnb";
            cmd = new SqlCommand(str, con);
            con.Open();
            cmd.Parameters.AddWithValue("@vnb", vnb);
            dr = cmd.ExecuteReader();
        ...
        {
            List<Menu> list = new List<Menu>();
            string str = "select * from Menu where Vnb=@vnb and UserId=@id";
            cmd = new SqlCommand(str, con);
            con.Open();
            cmd.Parameters.AddWithValue("@vnb", vnb);
            cmd.Parameters.AddWithValue("@id", id);
        ...
        {
            string str = "delete from Menu where Rid=@id";
            cmd = new SqlCommand(str, con);
            con.Open();
            cmd.Parameters.AddWithValue("@id", id);
            int res = cmd.ExecuteNonQuery();
        ...
        {
            string str = "update Menu set Rname=@rname,Photo=@image,Youtube=@youtube,Ingredient=@ingredient,HTM=@htm,Vnb=@vnb,Sname=@sname where Rid=@id";
            cmd = new SqlCommand(str, con);
            con.Open();
            cmd.Parameters.AddWithValue("@rname", m.RName);
            cmd.Parameters.AddWithValue("@image", m.Photo);
        ...
        {
            string str = "update Menu set Rname=@rname,Youtube=@youtube,Ingredient=@ingredient,HTM=@htm,Vnb=@vnb,Sname=@sname where Rid=@id";
            cmd = new SqlCommand(str, con);
            con.Open();
            cmd.Parameters.AddWithValue("@rname", m.RName);
            cmd.Parameters.AddWithValue("@youtube", m.Youtube);
